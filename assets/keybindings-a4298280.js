import { jW as ScanCodeUtils, vj as ScanCodeChord, vk as KeyCodeUtils, vl as KeyCodeChord, vm as Keybinding, i as MenuId, c as localize, vn as index, a6 as DisposableStore, gr as ExtensionsRegistry, aK as ThemeIcon, fz as joinPath, ig as isProposedApiEnabled, h as MenuRegistry, C as ContextKeyExpr, oW as isFalsyOrWhitespace, gu as __decorate, gv as __param, Z as Registry, hP as Extensions, a0 as CommandsRegistry, vo as AbstractKeybindingService, bu as KeybindingsRegistry, aI as addDisposableListener, bT as StandardKeyboardEvent, vp as printKeyboardEvent, vq as printStandardKeyboardEvent, aJ as EventType, vr as onDidChangeFullscreen, k9 as BrowserFeatures, jV as isFullscreen, vs as UserSettingsLabelProvider, cH as OS, vt as KeybindingResolver, vu as ResolvedKeybindingItem, vv as IMMUTABLE_CODE_TO_KEY_CODE, aT as isMacintosh, I as IContextKeyService, ak as ICommandService, cu as ITelemetryService, al as INotificationService, hw as IUserDataProfileService, iL as IHostService, h5 as IExtensionService, he as IFileService, hz as IUriIdentityService, fM as ILogService, vw as IKeyboardLayoutService, D as Disposable, aD as Emitter, j as RunOnceScheduler, bo as Event, b5 as dirname, hq as equals, ht as parse, d2 as isWindows, dz as isLinux, vx as getKeyboardLayoutId, _ as Extensions$1, vy as NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE, vz as toEmptyArrayIfContainsNull, vA as BaseResolvedKeybinding, vB as UILabelProvider, vC as IMMUTABLE_KEY_CODE_TO_CODE, vb as IEnvironmentService, aa as IStorageService, ay as IConfigurationService, uR as getNodeType, vD as FallbackKeyboardMapper, fn as timeout, b1 as IInstantiationService, bF as registerAction2, f6 as Action2, fY as Categories, a$ as IKeybindingService, hb as StandaloneServices, hx as IUserDataProfilesService, hf as VSBuffer, iQ as getServiceOverride$1, hh as SyncDescriptor, aq as toDisposable } from "./theme-defaults-f1cfa825.js";
import { g as getAllUnboundCommands } from "./unboundCommands-920832ba.js";
import { s as __vitePreload } from "./index-484e5cbb.js";
import "./workbench.contribution-886559e3.js";
...
let WorkbenchKeybindingService = class WorkbenchKeybindingService2 extends AbstractKeybindingService {
...
${rawMapping}`;
  ...
  _asCommandRule(extensionId, isBuiltin, idx, binding) {
    ...
    const keybinding = WorkbenchKeybindingService2.bindToCurrentPlatform(key, mac, linux, win);
    if (!keybinding) {
      return void 0;
    }
    let weight;
  ...
  getDefaultKeybindingsContent() {
    ...
    return WorkbenchKeybindingService2._getDefaultKeybindings(defaultKeybindings) + "\n\n" + WorkbenchKeybindingService2._getAllCommandsAsComment(boundCommands);
  }
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case "./keyboardLayouts/layout.contribution.darwin.js":
      return __vitePreload(() => import("./layout.contribution.darwin-256fbeff.js"), true ? ["assets/layout.contribution.darwin-256fbeff.js","assets/_.contribution-c13253ff.js"] : void 0).then((module) => module.default ?? module);
    case "./keyboardLayouts/layout.contribution.linux.js":
      return __vitePreload(() => import("./layout.contribution.linux-7bf6fcce.js"), true ? ["assets/layout.contribution.linux-7bf6fcce.js","assets/_.contribution-c13253ff.js"] : void 0).then((module) => module.default ?? module);
    case "./keyboardLayouts/layout.contribution.win.js":
      return __vitePreload(() => import("./layout.contribution.win-7e8beba7.js"), true ? ["assets/layout.contribution.win-7e8beba7.js","assets/_.contribution-c13253ff.js"] : void 0).then((module) => module.default ?? module);
    default:
